     ...
     <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div id="content">
         ...
         <div class="breadcrumb">
   					<li class="breadcrumb-item" aria-current="active">Wisata</li>
   			</div>
         <!-- Begin Page Content -->
        ...
        <div class="container-fluid">
          ...
          <table border="1" cellpadding="5">
               ...
               <tr>
                 ...
                 <td style="width:10%"><?= $row["nama_wisata"]  ?></td>
                 <td style="width:10%"><?= $row["nama_kategori"]  ?></td>
                 <td style="width:10%"><?= $row["alamat_wisata"]  ?></td>
                 <td style="width:5%"><?= $row["harga"]  ?></td>
                 <td style="width:30%"><?= $row["fasilitas"]  ?></td>
                 <td style="width:30%">

                   <a href="detailwisata.php?id_wisata=<?= $row["id_wisata"]  ?>">  <button class="btn btn-info">Lihat</button></a>
