      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
				...
				<div class="breadcrumb">
						<li class="breadcrumb-item"><a href="index_kategori.php">Wisata</a></li>
         ...
         <div class="addkategori">
                ...
                <div class="">
                  <div class="form-group">
									   ...
									   <input class="form-control" type="varchar" name="nama_wisata" id="nama_wisata" required>
								   </div>
                   ...
                   <div class="form-group">
                     ...
                     <input class="form-control" type="varchar" name="harga" id="harga" required>
                   </div>

                <div class="form-group">
                  <label for="fasilitas">Fasilitas :</label>
                  <textarea class="form-control" type="varchar" name="fasilitas" id="fasilitas" required></textarea>
                </div>

                <div class="form-group">
                  <label for="alamat_wisata">Lokasi :</label>
                  <textarea class="form-control" type="varchar" name="alamat_wisata" id="alamat_wisata" required></textarea>
                </div>


                <div class="form-group">
                  <label for="lampiran">Foto : </label>
                  <input class="form-control-file" type="file" name="lampiran" id="lampiran">
                </div>
