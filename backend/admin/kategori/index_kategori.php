     ...
     <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div id="content">
         ...
         <div class="breadcrumb">
   					<li class="breadcrumb-item" aria-current="active">Kategori</li>
   			</div>
         <!-- Begin Page Content -->
        ...
        <div class="container-fluid">
          ...
          <?php foreach ($kategori as $row) :
            ...
            if (strlen($nama_kategori) > 60) {
              $nama_kategori = substr($nama_kategori, 0, 60) . "...";
            }
            $deskripsi_kategori = $row["deskripsi_kategori"];
            if (strlen($deskripsi_kategori) > 100) {
              $deskripsi_kategori = substr($deskripsi_kategori, 0, 100) . "...";
            }
?>
           ...
           <div class="col-sm-3 mb-3">
             <div class="card" style="width:18rem;">
               <img src="<?= $row["foto_kategori"]; ?>" class="card-img-top" alt="gambar">
                  <div class="card-body">
